...
const SalesOffice_SalesArea = ({ formData, form2Data }) => {
          ...
          {formData != null ? (
            <div>
              ...
              >
                ...
                {formData.map((option) => (
                  <option key={option.form.Sales} value={option.form.Sales}>
                    {option.form.Sales}
                  </option>
                ))}
              </select>
            ...
            <div>
              ...
              >
                ...
                {form2Data.map((option) => (
                  <option key={option.form.Description} value={option.form.Description}>
...
export default SalesOffice_SalesArea;
