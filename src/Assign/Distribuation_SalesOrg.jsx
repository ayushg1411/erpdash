...
const Distribuation_SalesOrg = ({ formData, form2Data }) => {
          ...
          {formData != null ? (
            <div>
              ...
              >
                ...
                {formData.map((option) => (
                  <option key={option.form.Distribuation.Name} value={option.form.Distribuation.Name}>
                    {option.form.Distribuation.Name}
                  </option>
                ))}
              </select>
            </div>
...
export default Distribuation_SalesOrg;
