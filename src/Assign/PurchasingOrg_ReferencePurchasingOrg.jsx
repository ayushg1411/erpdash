...
const PurchasingOrg_ReferencePurchasingOrg = ({ tableHead, formData, form2Data }) => {
          ...
          {formData != null ? (
            <div>
              ...
              >
                ...
                {formData.map((option) => (
                  <option
                    key={option.form["Purchase Organization"]}
                    value={option.form["Purchase Organization"]}
                  >
            ...
            <div>
              ...
              >
                ...
                {form2Data.map((option) => (
                  <option key={option.form.Descrition} value={option.form.Descrition}>
...
export default PurchasingOrg_ReferencePurchasingOrg;
